...
# set java binary
# JAVA_HOME=/var/scratch/jason/JVMs/ibm-java-x86_64-60
# JAVA_HOME=/var/scratch/tpkessel/jrrt-3.1.2-1.6.0/
# JAVA_HOME=/usr/local/package/jdk1.6.0_17-linux-amd64
# JAVA_HOME=/usr/local/package/jdk1.5.0_14-linux-amd64
JAVA_HOME="/cm/shared/package/sun-jdk/jdk1.6.0_27"
