...
public class BiLineTest {

	@Test(expected = GraphCreationException.class)
	public void cannotCreateEmptyBiLine() throws GraphCreationException {
		new BiLine(0);
	}

	@Test(expected = GraphCreationException.class)
	public void cannotCreateNegativeSizeBiLine() throws GraphCreationException {
		new BiLine(-1);
	}

	@Test
	public void computesSize() throws GraphCreationException {
		assertEquals(100L, new BiLine(100).estimateGlobalNodes());
		assertEquals(198L, new BiLine(100).estimateGlobalTransitions());
	}

	@Test
	public void canComputeTranspose() throws GraphCreationException {
		assertTrue(new BiLine(10).canSynthetizeTranspose());
	}

	@Test
	public void createsOneElementBiLine() throws GraphCreationException {
		BiLine line = new BiLine(1);
	...
	@Test
	public void createsTwoElementsBiLine() throws GraphCreationException {
		BiLine line = new BiLine(2);
		TestSyntheticGraphMaker maker = new TestSyntheticGraphMaker(line);
		line.create(maker);
	...
	@Test
	public void createsThreeElementsBiLine() throws GraphCreationException {
		BiLine line = new BiLine(3);
		TestSyntheticGraphMaker maker = new TestSyntheticGraphMaker(line);
		line.create(maker);
		...
		assertEquals(4, maker.totalNumTransitions());
	}

	@Test
	public void createsTenElementsBiLine() throws GraphCreationException {
		BiLine line = new BiLine(10);
		TestSyntheticGraphMaker maker = new TestSyntheticGraphMaker(line);
		line.create(maker);
		...
		for (int i = 0; i < 10; ++i) {
			for (int j = 0; j < 10; ++j) {
				assertEquals(j == i + 1 || j == i - 1 ? 1 : 0, maker.get(i, j));
			}
		}
	}
	...
	public void testToString() throws GraphCreationException {
		assertEquals("BiLine(100)", new BiLine(100).toString());
	}
}
