...
/** A line graph with n nodes and 2*(n-1) transitions. */
public class BiLine implements SyntheticGraph {
	private final long n;

	public BiLine(final long n) throws GraphCreationException {
		if (n <= 0) {
